...
import jp.seraphr.narou.api.model.NovelApiResponse
...
class NovelApiResponseDecoderTest extends AnyFreeSpec with Matchers {
  ...
  "NovelApiResponseのJSONデコード" - {
    ...
    "実際のAPIレスポンスをデコードできること" in {
      ...
      tFirstNovel.biggenre should be(2)
      tFirstNovel.genre should be(201)
      tFirstNovel.novel_type should be(2)
      tFirstNovel.end should be(0)
      tFirstNovel.length should be(119652)
      tFirstNovel.iszankoku should be(1)
      tFirstNovel.istensei should be(1)
      ...
      tSecondNovel.biggenre should be(2)
      tSecondNovel.genre should be(202)
